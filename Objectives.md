...
| --- | --- | --- | --- |
| Tested Code | Code delivered under the order must have substantial test code coverage. Version-controlled CMS GitHub repository of code that comprises product that will remain in the government domain. | Minimum of 80% test coverage of all code measured by [Codecov](https://codecov.io/). All areas of code are meaningfully tested. | Combination of manual review and automated testing |
